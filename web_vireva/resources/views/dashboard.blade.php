<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 animate__animated animate__fadeIn">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
                <div class="text-slate-400 text-[10px] font-bold uppercase tracking-widest mb-1">Loyalty Points</div>
                <div class="text-2xl font-black text-emerald-600">{{ ($totalSelesai ?? 0) * 150 }} <span class="text-[10px] text-slate-400 uppercase">Pts</span></div>
            </div>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="h-48 rounded-3xl overflow-hidden relative border border-slate-800 shadow-2xl group cursor-pointer hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] transition-all">
                    ...
                    <div class="relative h-full p-6 flex flex-col justify-between z-10">
                        ...
                        <div>
                            <div class="text-xs text-slate-400 tracking-widest uppercase mb-1">Keistimewaan Member</div>
                            <div class="font-mono text-sm tracking-[0.2em] text-white/90">
                                VRV-{{ Auth::user()->created_at->format('Y') }}-{{ str_pad(Auth::id(), 4, '0', STR_PAD_LEFT) }}
                            </div>
