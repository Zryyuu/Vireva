...
@section('content')
                ...
                <div class="lg:col-span-6 relative animate__animated animate__fadeInRight animate__delay-1s mt-12 lg:mt-0 order-1 lg:order-2">
                    <div class="relative group">
                        ...
                        <div class="aspect-[16/10] sm:aspect-video lg:aspect-[16/10] bg-dark overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.25)]">
                            <img src="{{ asset('images/hero.jpg') }}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[3000ms]" alt="Pemandangan Eksterior Villa Mewah Vireva">
                        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                <div class="relative grid grid-cols-1 sm:grid-cols-2 gap-6 animate__animated animate__fadeInLeft">
                    <div class="space-y-4 pt-12">
                        <img src="{{ asset('images/about_1.jpg') }}" class="w-full h-64 sm:h-80 object-cover shadow-2xl hover:scale-105 transition-transform duration-700" alt="Arsitektur Modern Villa Vireva">
                    ...
                    <div>
                        <img src="{{ asset('images/about_2.jpg') }}" class="w-full h-[24rem] sm:h-[32rem] object-cover shadow-2xl hover:scale-105 transition-transform duration-700" alt="Interior Eksklusif Vireva Luxury Retreat">
                    </div>
                </div>
                ...
                <div class="animate__animated animate__fadeInRight text-center lg:text-left mt-12 lg:mt-0">
                    ...
                    <a href="#philosophy" class="inline-flex items-center gap-4 text-dark font-bold uppercase tracking-[0.2em] group">
                        Cerita Kami
    ...
    <section id="services" class="min-h-screen lg:h-[80vh] lg:min-h-[600px] bg-dark flex flex-col lg:flex-row overflow-hidden relative group/section">
        ...
        <div id="{{ $svc['slug'] }}" class="relative flex-none h-64 sm:h-80 lg:h-full lg:flex-1 lg:hover:flex-[2.5] transition-all duration-700 ease-in-out overflow-hidden border-b lg:border-b-0 lg:border-r border-white/5 group">
            <img src="{{ asset('images/' . $svc['img']) }}" class="absolute inset-0 w-full h-full object-cover grayscale-[0.5] opacity-40 group-hover:opacity-100 group-hover:grayscale-0 group-hover:scale-110 transition-all duration-[2000ms]" alt="Fasilitas {{ $svc['title'] }} di Villa Vireva">
