...
<head>
    ...
    <title>@yield('title', 'Vireva') - Luxury Retreat & Private Villas</title>
    <meta name="description" content="Vireva Luxury Retreat menawarkan pengalaman menginap eksklusif di villa pribadi dengan desain modern, fasilitas premium, dan layanan yang personal di Jawa Timur.">
    <meta name="keywords" content="villa mewah, luxury retreat, booking villa, penginapan eksklusif, vireva villa">
...
<body id="top" class="bg-white text-dark antialiased overflow-x-hidden" x-data="{ mobileMenu: false }">
    ...
    <footer id="footer" class="bg-dark text-white pt-24 pb-12">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 border-b border-white/10 pb-16">
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-4">
                    <!-- Instagram -->
                    <a href="https://instagram.com/Zryyuu_" target="_blank" class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#E4405F] hover:border-[#E4405F] text-white transition-all group shadow-lg">
                    ...
                    <!-- Twitter (X) -->
                    <a href="https://twitter.com/zryyuux" target="_blank" class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-black hover:border-white/20 text-white transition-all group shadow-lg">
                        <svg class="w-4 h-4 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <!-- Facebook -->
                    <a href="https://facebook.com/Zryyuu" target="_blank" class="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#1877F2] hover:border-[#1877F2] text-white transition-all group shadow-lg">
                        <svg class="w-4 h-4 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-4 text-sm font-bold uppercase tracking-widest">
                    ...
                    <li><a href="{{ request()->is('/') ? '#philosophy' : url('/#philosophy') }}" class="hover:text-primary transition-colors flex items-center gap-3"><span class="w-4 h-[1px] bg-primary"></span> Filosofi</a></li>
                </ul>
            </div>
        ...
        <div class="max-w-7xl mx-auto pt-12 px-6 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase font-bold tracking-[0.2em]">
            <div>&copy; {{ date('Y') }} VIREVA LUXURY STAY. Hak cipta dilindungi undang-undang.</div>
